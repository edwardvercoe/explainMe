...
'Natalie Portman.',
'Waking up half-naked in a Dennys parking lot.',
'God.',
'Sean Connery.',
'Saxophone solos.',
'Gloryholes.',
...
'Lactation.',
'Being fabulous.',
'Shaquille ONeals acting career.',
...
function newEmotion() {
	let randomNumber = Math.floor(Math.random() * (emotion.length));

document.getElementById('emotionDisplay').innerHTML = emotion[randomNumber];

}


function newPunchline() {
	let randomNumber2 = Math.floor(Math.random() * (punchline.length));

document.getElementById('punchlineDisplay').innerHTML = punchline[randomNumber2];
